...
// Se crea la clase Room, en la cual los parametros deben coincidir con los campos de la tabla Rooms de la base de datos
case class Room(id: Int, name: String, locationId: Int, description: String, rating: Double, price: Double, thumbnail: String)

// Tambien se crea un objeto Room con el fin de implementar los metodos para escribir Room como si fueran Jsons
object Room {
